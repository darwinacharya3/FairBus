...
//       bool isAdminUser = userData['isAdmin'] == true;
//       bool isDriverUser = userData['isDriver'] == true;
      
//       isAdmin.value = isAdminUser;
//       isDriver.value = isDriverUser;
...
//         await Get.offAllNamed('/driver', arguments: {
//           'driverId': uid,
//           'username': username
//         });
//       } else {
...
//         await Get.offAllNamed('/admin/dashboard');
//       } else if  (isDriverUser) {
//         // Navigate to driver screen if user is a driver
//         await Get.offAllNamed('/driver', arguments: {
//           'driverId': uid,
//           'username': username
//         },);}
